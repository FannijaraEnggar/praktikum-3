        ...
        <nav class="navbar fixed-top navbar-expand-lg bg-purple" data-bs-theme="dark">
            ...
            <div class="container py-2 px-4">
                ...
                <a href="#" class="navbar-brand mb-0 h1">
                    <img class="ing-fluid" src="{{ Vite::asset('resources/images/logo-white.png') }}" alt="logo white">
                </a>
                <!-- Navbar Toggler -->
            ...
            <div class="container py-5 px-4">
                <div class="row">
                    <div class="col-md-5 order-md-2">
                        <img class="ing-fluid" src="{{ Vite::asset('resources/images/main.png') }}" alt="main logo">
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-3 mb-5">
                        <a href="#" class="logo text-decoration-none">
                            <div class="d-flex">
                                <img class="img-fluid" src="{{ Vite::asset('resources/images/logo-black.png') }}" alt="Bootstrap Logo" style="width: 40px;">
