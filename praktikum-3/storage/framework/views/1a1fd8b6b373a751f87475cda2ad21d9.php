...
<body>
    <div class="container m-5">
        ...
        <div class="list-group list-group-numbered mt-4">
            ...
            <a href="<?php echo e(url('/view_bootstrap')); ?>" class="list-group-item list-group-item-action">
                View Bootstrap
            </a>
        </div>
...
<?php /**PATH C:\Users\fengg\praktikum-3\resources\views/routing.blade.php ENDPATH**/ ?>